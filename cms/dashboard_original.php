...
?>
	...
	<div id="left_menu">
		...
		<ul id="main_menu">
			<li><a href="dashboard.php"><img src="images/icon_home.png" alt="Home"/>Inicio</a></li>
			<li>
				<a id="menu_pages" href=""><img src="images/icon_pages.png" alt="Pages"/>Páginas</a>
				<ul>
					<li><a href="">Adicionar página</a></li>
					<li><a href="">Editar página</a></li>
				</ul>
			</li>
			<li>
				<a href=""><img src="images/icon_posts.png" alt="Posts"/>Blog</a>
				<ul>
			...
			<li>
				...
				<ul>
					<li><a href="">Adicionar Media</a></li>
					<li><a href="">Editar Media</a></li>
					<li><a href="">Eliminar Media</a></li>
				</ul>
			</li>
			<li>
				<a href=""><img src="images/icon_users.png" alt="Users"/>Utilizadores</a>
				<ul>
					<li><a href="">Adicionar Utilizador</a></li>
					<li><a href="">Editar Utilizador</a></li>
					<li><a href="">Eliminar Utilizador</a></li>
				</ul>	
			</li>
		</ul>
		<br class="clear"/>
	...
	<div id="content">
		<div class="inner">
			<h1>MxM BackOffice v3.1</h1>
			
			<!-- Begin shortcut menu -->
			<ul id="shortcut">
    			<li>
    			  <a href="dashboard.php" id="shortcut_home" title="Click me to open modal window">
