...
$settings["files"]["url_dir"] 	= "http://portugalwestzone.com/cms/tiny_mce/FileUpload/files/"; //with the trailing slash!
$settings["files"]["ext"] 	= array("*");
$settings["files"]["type"] 	= 1; //1 => file browser, 2 => image browser
$settings["img"]["dir"] 	= "./FileUpload/pics/"; //with the trailing slash!
$settings["img"]["url_dir"] 	= "http://portugalwestzone.com/cms/tiny_mce/FileUpload/pics/"; //with the trailing slash!
...
$settings["media"]["url_dir"] 	= "http://portugalwestzone.com/cms/tiny_mce/FileUpload/files/"; //with the trailing slash!
...
include("file_manager/lang/lang_pt.php");
